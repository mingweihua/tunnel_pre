...
$.fn.pagination.defaults={total:1,pageSize:20,pageNumber:1,pageList:[20,30,40,50],loading:false,buttons:null,showPageList:true,showRefresh:true,onSelectPage:function(_9c,_9d){
...
if(opts.closable){
$("<a class=\"panel-tool-close\" href=\"javascript:void(0)\"></a>").appendTo(tool).bind("click",function(){//$.messager.progress('close');
_1db(_1d8);
return false;
});
}
...
win.window("close");
if($(".messager-input",win).val().length==0){$(".messager-input",win).val('  ')};
if(fn){
