...
class Model_operation {
    ...
    static sectionModel(object, modelName) {
        ...
        scene.remove(object.three3dObject.cloud.currentModel);
        scene.remove(object.three3dObject.group_pouqie.currentModel);
        if(object.three3dObject.group_pouqie.currentModel.geometry!= undefined){
            object.three3dObject.group_pouqie.currentModel.geometry.dispose();
        }
        
        if(object.three3dObject.group_pouqie.currentModel.material)object.three3dObject.group_pouqie.currentModel.material.dispose();
        if(object.three3dObject.group_pouqie.currentModel.texture)object.three3dObject.group_pouqie.currentModel.texture.dispose();
