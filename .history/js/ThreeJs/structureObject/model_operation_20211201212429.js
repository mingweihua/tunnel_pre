...
class Model_operation {
    ...
    static twoPointSection() {
        ...
        let point1 = new THREE.Plane(new THREE.Vector3(-1, 0, 0), 200)
        let point2 = new THREE.Plane(new THREE.Vector3(0, -1, 0), 1000)
        let point3 = new THREE.Plane(new THREE.Vector3(0, 0, -1), 1000)
